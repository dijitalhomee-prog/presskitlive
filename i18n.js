...
const i18nTranslations = {
  tr: {
    ...
    feat_1_desc: "Konser, lansman veya dizi/film projelerine özel sınırsız fotoğraf klasörü açın. Yetkisiz indirmeyi engellemek için tek tıkla şifreleyin.",
    feat_2_title: "300 DPI Headshot & Baskı Kalitesi",
    feat_2_desc: "Görselleriniz (baskı afişleri ve oyuncu headshot portreleri) hiçbir sıkıştırmaya uğramadan tam çözünürlüğünde saklanır.",
    feat_3_title: "Logo, Tipografi & Biyografi Deposu",
    ...
    // Pricing Plans
    plan_individual_name: "Bireysel Sanatçı / DJ",
    plan_individual_limit: "1 Profil Limiti",
    plan_starter_name: "Starter Menajer Paketi",
    plan_starter_limit: "4 Profil Limiti",
    plan_pro_name: "Pro Menajer Ajansı",
    plan_pro_limit: "10 Profil Limiti",
    plan_enterprise_name: "Enterprise Ajans",
    plan_enterprise_limit: "50 Profil Limiti",
    badge_most_popular: "En Çok Tercih Edilen",
    ...
    btn_start_sub: "Aboneliği Başlat",
    btn_start_pro: "Aboneliği Başlat",
    btn_start_enterprise: "Aboneliği Başlat",
    ...
    login_account_type_label: "Hesap Tipi *",
  ...
  en: {
    ...
    feat_1_desc: "Create unlimited photo folders for concerts, releases, or film projects. Lock with one click to protect against unauthorized downloads.",
    feat_2_title: "300 DPI Headshots & Print Quality",
    feat_2_desc: "Your assets (print posters and talent headshot portraits) are stored in full uncompressed high resolution.",
    feat_3_title: "Logos, Typography & Biography Hub",
    ...
    // Pricing Plans
    plan_individual_name: "Individual Artist / DJ",
    plan_individual_limit: "1 Profile Limit",
    plan_starter_name: "Starter Manager Plan",
    plan_starter_limit: "4 Profile Limit",
    plan_pro_name: "Pro Agency Plan",
    plan_pro_limit: "10 Profile Limit",
    plan_enterprise_name: "Enterprise Agency Plan",
    plan_enterprise_limit: "50 Profile Limit",
    ...
    btn_start_pro: "Start Subscription",
    btn_start_enterprise: "Start Subscription",
    ...
    login_account_type_label: "Account Type *",
...
function setLanguage(lang) {
  ...
  // Update all elements with data-i18n-html attribute (for HTML formatted strings)
